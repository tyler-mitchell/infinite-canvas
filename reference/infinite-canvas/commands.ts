...
import { DEFAULT_INFINITE_CANVAS_ZOOM } from "#/experiments/infinite-canvas/constants";
import { zoomCameraAtScreenPoint } from "#/experiments/infinite-canvas/geometry";
import {
  clearSelection,
