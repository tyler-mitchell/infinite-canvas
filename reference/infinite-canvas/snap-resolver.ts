import { DEFAULT_INFINITE_CANVAS_SNAP_POLICY } from "#/experiments/infinite-canvas/constants";
import {
  buildSnapCandidates,
  getMoveSnapAnchors,
  getResizeSnapAnchors,
} from "#/experiments/infinite-canvas/snap-candidates";
import type {
  SnapAdjustment,
  SnapAnchor,
  SnapCandidate,
} from "#/experiments/infinite-canvas/snap-types";
import type {
  InfiniteCanvasRect,
